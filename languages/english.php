...
DEFINE('_INST_CFG_NEARMAP_ACCESS','NearMap access');
DEFINE('_INST_CFG_NEARMAP_ACCESS_MAN','Do you wish to enable access to NearMap photomap layers?<br>You will need to provide the authentication details below in order to use them:');
DEFINE('_INST_CFG_NEARMAP_SUPPORT','Enable NearMap layers?');
DEFINE('_INST_CFG_NEARMAP_USER','NearMap user ID');
DEFINE('_INST_CFG_NEARMAP_PWD','NearMap password');
...
DEFINE('_MENU_WPT_SAVE','save Waypoint');
