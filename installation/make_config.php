...
$cfg['nearmap_support'] = (bool) getUrlParam('HTTP_POST', 'STRING', 'nearmap_support');
$cfg['nearmap_user'] 	= getUrlParam('HTTP_POST', 'STRING', 'nearmap_user');
$cfg['nearmap_pwd'] 	= getUrlParam('HTTP_POST', 'STRING', 'nearmap_password');
